...
const Testimonial = () => {
  ...
  return (
    ...
    <div id='testimonial' className='flex flex-col items-center my-10 scroll-mt-12'>
        ...
        <Title title="Dont just take our words" description='Hear what our users say about us. We are looking for ways to improve. If you have a positive experience with us, leave a review.'/> 
    </div>
